<nav aria-label="breadcrumb">
            ...
            <div class="col-md-6 offset-md-3 mt-5 form-container">
               ...
               <div class="alert alert-success alert-dismissible fade show" role="alert">
                ...
                <?php }?>
            	<h2 class="mt-5"><i class="fas fa-user-plus"></i> Edit User</h2>
               <form class="mt-5" action="../../controller/UserController.php" method="post"> 
               <div class="form-group">
               	<div class="row">
                <label for="username" class="col-md-4">User Name:</label>
                <input type="text" name="username" class="form-control col-md-8" id="username" value="<?php echo $userData['name']; ?>">
                <?php
               ...
               <div class="form-group">
                ...
                <input type="email" name="email" class="form-control col-md-8" id="email" value="<?php echo $userData['email']; ?>">
                <?php
               ...
               <div class="form-group">
                ...
                <input type="password" name="password" class="form-control col-md-8" id="password" value="<?php echo $userData['password']; ?>">
                <?php
